...
app.post('/users', async function (req, res) {
    ...
    let response = await helper.getRegisteredUser(username, orgName, roll, true);
...
app.post('/register', async function (req, res) {
    ...
    let response = await helper.registerAndGerSecret(username, orgName, roll);
...
app.get('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        let message = await query.query(channelName, chaincodeName, args, fcn, req.username, req.orgname, data);
